...
/*
    ...
    ============================================================
    EQ 5 bandes + coupe-bas/coupe-haut + Air, fréquence ET gain
    réglables sur chaque bande à cloche :
...
public:
    void prepare (double sampleRateIn)
    {
        ...
        for (int ch = 0; ch < 2; ++ch)
        {
            ...
            lowShelf[ch].reset(); lowMidBell[ch].reset(); midBell[ch].reset(); highMidBell[ch].reset(); highShelf[ch].reset();
...
private:
    void updateCoefficients()
    {
        ...
        auto midCoeffs      = juce::dsp::IIR::Coefficients<float>::makePeakFilter (sampleRate, midFreq, 0.9f, juce::Decibels::decibelsToGain (midGain));
    ...
    float lowGain = 0.0f, lowMidGain = 0.0f, midGain = 0.0f, highMidGain = 0.0f, highGain = 0.0f;
    float lowFreq = 120.0f, lowMidFreq = 300.0f, midFreq = 1000.0f, highMidFreq = 3000.0f, highFreq = 8000.0f;
    ...
    juce::dsp::IIR::Filter<float> lowShelf[2], lowMidBell[2], midBell[2], highMidBell[2], highShelf[2];
